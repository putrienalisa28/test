...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysamin' => [
            'driver' => 'sqlsrv',
            // 'host' => env('DB_MYSAMIN_HOST', '127.0.0.1'),
            // 'port' => env('DB_MYSAMIN_PORT', '1433'),
            // 'database' => env('DB_MYSAMIN_DATABASE', 'forge'),
            // 'username' => env('DB_MYSAMIN_USERNAME', 'forge'),
            // 'password' => env('DB_MYSAMIN_PASSWORD', ''),
            'host' => '192.168.12.5',
            'port' => env('DB_MYSAMIN_PORT', '1433'),
            'database' => 'RSUPDB',
            'username' => 'uKoneksi',
