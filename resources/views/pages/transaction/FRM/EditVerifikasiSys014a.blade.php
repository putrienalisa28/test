...
@section('content')
                        ...
                        <form id="form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>No : </label>
                                                        @if ($header['nomor'] == 'WTP')
                                                            {{ trim($header['nomor']) }}/WPM
                                                        @else
                                                            {{ $header['nomor'] }}
                                                        @endif
                                                        <input id="department" class="form-control" type="hidden"
                                                            value="{{ $header['dept_id'] }}" name="department">
                                                        <input id="checkid" class="form-control" type="hidden"
                                                            value="{{ $header['checkid'] }}" name="checkid">
                                                        <input id="headerid" class="form-control" type="hidden"
                                                            value="{{ $header['headerid'] }}" name="headerid">
                                                        <input id="id" class="form-control" type="hidden" name="id" value="{{ $header['id'] }}">
                                                    </div>
                                                </div><br><br>
                                                <div class="form-group">
                                                    <label>Tanggal :</label>{{ $header['tanggal'] }}
                                                    <input id="tanggal" class="form-control" type="hidden"
                                                        value="{{ $header['tanggal'] }}" name="tanggal" readonly>
                                                </div>
                                            </div>
                                        </th>
                                    </tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9"> {{ $header['area'] }}
                                                            <input type="hidden" x-model="area" name="area"
                                                                id="area" value="{{ $header['area'] }}" placeholder="Enter Code"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="input" x-model="shift" name="shift"
                                                                id="shift" value="{{ $header['shift'] }}" placeholder="Enter Code"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="total_jam" class="form-control" type="hidden"
                                                                    value="{{ $header['total_jam'] }}" name="total_jam">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label for="exampleFormControlInput1"
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;{{ $header['jenis_kerusakan'] }}</label>
                                                    <input id="kerusakan" class="form-control" type="hidden"
                                                        value="{{ $header['jenis_kerusakan'] }}" name="kerusakan">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label for="exampleFormControlInput1"
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;{{ $header['tindakan'] }}</label>
                                                    <input id="tindakan" class="form-control" type="hidden"
                                                        value="{{ $header['tindakan'] }}" name="tindakan">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered table-responsive">
                                ...
                                <tbody id="tbody-list-detail">
                                    ...
                                    <tr style="cursor: pointer;" row="{{ $key+1 }}">
                                        ...
                                        <td style="text-align: center;">
                                            <input id="detail_id" class="form-control" type="hidden" value="{{ $data['headerid'] }}" name="detail_id[]">
                                            <input id="sparepart_dibawa" class="form-control" type="text" name="sparepart_dibawa[]" value="{{ $data['sparepart_dibawa'] }}"></td>
                                        <td style="text-align: center;"><input id="quantity_dibawa" class="form-control" type="number" name="quantity_dibawa[]" value="{{ $data['quantity_dibawa'] }}"></td>
                                        <td style="text-align: center;"><input id="sparepart_kembali" class="form-control" type="text" name="sparepart_kembali[]" value="{{ $data['sparepart_kembali'] }}"></td>
                                        <td style="text-align: center;"><input id="quantity_kembali" class="form-control" type="number" name="quantity_kembali[]" value="{{ $data['quantity_kembali'] }}"></td>
                                        <td style="text-align: center;"><input id="keterangan" class="form-control" type="text" name="keterangan[]" value="{{ $data['keterangan'] }}"></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-responsive">
                                ...
                                <tbody id="tbody-list-detail-2">
                                    ...
                                    <td style="text-align: center;">
                                        <input id="detail_id2" class="form-control" type="hidden" value="{{ $data2['headerid'] }}" name="detail_id2[]">
                                        <input id="sparepart_pasang" class="form-control" type="text" name="sparepart_pasang[]" value="{{ $data2['sparepart_pasang'] }}"></td>
                                    <td style="text-align: center;"><input id="quantity_pasang" class="form-control" type="number" name="quantity_pasang[]" value="{{ $data2['quantity_pasang'] }}"></td>
                                    <td style="text-align: center;"><input id="sparepart_rusak" class="form-control" type="text" name="sparepart_rusak[]" value="{{ $data2['sparepart_rusak'] }}"></td>
                                    <td style="text-align: center;"><input id="quantity_rusak" class="form-control" type="number" name="quantity_rusak[]" value="{{ $data2['quantity_rusak'] }}"></td>
                                    <td style="text-align: center;"><input id="keterangan2" class="form-control" type="text" name="keterangan2[]" value="{{ $data2['keterangan'] }}"></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>1.<select id="dikerjakan_oleh" class="select2 form-select"
                                            ...
                                            @foreach ($jabatan3 as $nama)
                                                <option value="{{ $nama->NAMA }}" {{ $nama->NAMA == $header->dikerjakan_by ? 'selected' : '' }}>{{ $nama->NAMA }}</option>
                                                @endforeach
                                        </select>
                                        </td>
                                        <td>2.<select id="dikerjakan_oleh2" class="select2 form-select"
                                            ...
                                            <option value=""></option>
                                            @foreach ($jabatan3 as $nama)
                                                <option value="{{ $nama->NAMA }}" {{ $nama->NAMA == $header->dikerjakan2_by ? 'selected' : '' }}>{{ $nama->NAMA }}</option>
                                                @endforeach
                                        </select>
                                        </td>
                                        <td>3.<select id="dikerjakan_oleh3" class="select2 form-select"
                                            ...
                                            <option value=""></option>
                                            @foreach ($jabatan3 as $nama)
                                                <option value="{{ $nama->NAMA }}" {{ $nama->NAMA == $header->dikerjakan3_by ? 'selected' : '' }}>{{ $nama->NAMA }}</option>
                                                @endforeach
                                        </select>
                                        </td>
                                        <td>4.<select id="dikerjakan_oleh4" class="select2 form-select"
                                            ...
                                            <option value=""></option>
                                            @foreach ($jabatan3 as $nama)
                                                <option value="{{ $nama->NAMA }}" {{ $nama->NAMA == $header->dikerjakan4_by ? 'selected' : '' }}>{{ $nama->NAMA }}</option>
                                                @endforeach
                                        </select>
                                        </td>
                                    <tr>
                                    ...
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                                ...
                                                <td style="vertical-align: middle; text-align: left;">Nama
                                                    ...
                                                    @foreach ($jabatanqad as $nama3)
                                                            <option data-jabatan3="{{ $nama3->JabatanName }}" data-regno3="{{ $nama3->RegNo }}" data-idjabatan3="{{ $nama3->JabatanID }}"
                                                                value="{{ $nama3->NAMA }}" {{ $nama3->NAMA == $header->app3_by ? 'selected' : '' }}>{{ $nama3->NAMA }}</option>
                                                        @endforeach
                                                </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; text-align: left;">
                                                    Jabatan (position):
                                                    <input type="text" id="app3_jabatan" class="form-control" name="app3_jabatan" value="{{ $header->app3_jabatan }}" readonly>
                                                    <input type="hidden" id="regno3" class="form-control" name="regno3" value="{{ $header->app3_regno}}">
    ...
    <script>
        function komplit() {
            ...
            swAlertConfirm('{{ route('frm.komplit_verifikasi') }}', undefined, undefined, formData + '&' + formData2);
        }
        ...
        function tambah_baris() {
			...
			<tr row="${jumlah_baris}"> 
                ...
                <td style="text-align: center;">
                    <input id="detail_id" class="form-control" type="hidden" value="{{ $header['headerid'] }}" name="detail_id[]">
        ...
        function tambah_baris2() {
			...
			<tr row="${jumlah_baris}"> 
                ...
                <td style="text-align: center;">
                    <input id="detail_id2" class="form-control" type="hidden" value="{{ $header['headerid'] }}" name="detail_id2[]">
                    <input id="sparepart_pasang" class="form-control" type="text" name="sparepart_pasang[]"></td>
