...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="fw-semibold mb-4">List Approval </h4>

        <div class="alert alert-info d-flex align-items-center" role="alert">
            <span class="alert-icon text-info me-2">
                <i class="ti ti-info-circle ti-xs"></i>
            </span>
            Silahlkan Pilih Salah Satu Form Untuk Melakukan Approval
        </div>
        <!-- Role cards -->
        <div class="row g-4">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectStatusId">
                                    @if ($form['link_approval'] != '')
                                        <a class="dropdown-item"
                                            href="{{ route('frm.content', $form['form_id']) }}">View More</a>
                                    @endif
                                </div>
                            </div>
                        </div>
