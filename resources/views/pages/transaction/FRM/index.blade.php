...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="fw-semibold mb-4">List Of Form Input</h4>
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            {{-- <button type="button" class="btn text-nowrap d-inline-block">
                                <span class="tf-icons ti-sm ti ti-bookmark"></span>
                                <span
                                    class="badge rounded-pill bg-danger text-white badge-notifications">{{ $header1 }}</span>
                            </button> --}}
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectStatusId">
                                {{-- @if($form['form_route'] != '' && $form['form_route'] != ''formsystahun) --}}
                                <a class="dropdown-item" href="{{ route($form['form_route'],$form['form_id']) }}">View More</a>
                                {{-- @endif --}}
                            </div>
                        </div>
                    </div>
