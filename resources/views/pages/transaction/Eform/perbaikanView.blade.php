...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        <form id="form-data">
            ...
            <input type="hidden" name="" id="department" value="{{ $hasil_bilingual->first()->dept }}" readonly>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                ...
                                <table class="table table-responsive table-bordered table-striped table-hover">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        @foreach ($hasil_bilingual as $x)
                                            ...
                                            <td>
                                                <input type="time" name="mulai[]" value="{{ $x->mulai }}"
                                                    class="form-control form-control-plaintext form-control-sm">
                                            </td>
                                            <td>
                                                <input type="time" name="selesai[]" value="{{ $x->selesai }}"
                                                    class="form-control form-control-plaintext form-control-sm">
                                            </td>
                                            <td>
                                                <input type="text" name="totaljam[]" value="{{ $x->totaljam }}"
                                                    class="form-control form-control-plaintext form-control-sm">
                                            </td>
                                            <td>
