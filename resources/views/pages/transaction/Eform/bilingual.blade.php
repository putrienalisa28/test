...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        <form id="form-data">
            @csrf
            <input type="hidden" name="hdrsys" value="{{ $hasil_bilingual->first()->hdr_id }}" readonly>
            <input type="hidden" id="department" value="{{ $hasil_bilingual->first()->dept }}" readonly>
            <input type="hidden" name="mesinid" id="mesinid" value="{{ $hasil_bilingual->first()->mesin_id }}">
            <input type="hidden" name="mesinname" id="mesinname" value="{{ $hasil_bilingual->first()->machine_name }}">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <tr style="text-align:center;">
                                        ...
                                        <th style="width: 50px;" rowspan="">
                                            ...
                                            <input type="text" name="nosurat" id="nosurat"
                                                value="{{ $hasil_bilingual->first()->nosurat }}"
                                    ...
                                    <tr style="text-align:center;">
                                        ...
                                        <th style="width: 50px;" rowspan="">
                                            ...
                                            <input type="hidden" name="dept"
                                                value="{{ $hasil_bilingual->first()->dept }}"
                                                class="form-control form-control-plaintext form-control-sm"
                                                style="text-align:center; display: block; font-weight: bold;" readonly>
