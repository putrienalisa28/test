                                            ...
                                            <tr style="text-align:center;">
                                                ...
                                                <th style="width: 50px;">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input type="date" name="tanggalverifikasi"
                                                            value="{{ $y->tanggal_sys }}"
                                                            class="form-control form-control-sm" readonly>
                ...
                <div class="accordion-body m-3">
                    <div class="table-responsive text-nowrap pt-3">
                        <table class="table table-responsive table-bordered table-striped table-hover" id="myTable">
                            ...
                            <tbody>
                                <tr>
                                    <td name="poin[]" value="1">1</td>
                                    <td>Apakah setelah perbaikan mesin dan area disekitar perbaikan dibersihkan</td>

                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[1]"
                                            id="inlineRadio1" value="t" />
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[1]"
                                ...
                                <tr>
                                    <td name="poin[]" value="2">2</td>
                                    <td>Apakah mesin / alat yang diperbaiki bebas dari bahaya yang bisa menyebabkan
                                        kontaminasi

                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[2]" value="t"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[2]" value="f"
                                            class="form-control form-control-sm">
                                    </td>

                                </tr>
                                <tr>
                                    <td name="poin[]" value="3">3</td>
                                    <td>Apakah mesin bisa dijalankan untuk proses produksi</td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[3]" value="t"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[3]" value="f"
                                            class="form-control form-control-sm">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[4]" value="t"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox" name="status[4]" value="f"
                                            class="form-control form-control-sm">
                                    </td>
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: '{{ route('verifikasistore.store') }}',
                            type: "POST",
                            data: formData,
                            headers: {
