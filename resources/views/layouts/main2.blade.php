            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <img src="{{ url('img/logo-sambu-group.png') }}" style="width: 195px;">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @foreach ($menuHeaders as $key => $item)
                        <li class="menu-header small text-uppercase">
                            <span class="menu-header-text text-bold">{{ $item->menuhdr_title }}</span>
                        </li>
                        @foreach ($item->subMenus as $key => $subMenu)
                            <li class="menu-item">
                                <a href="{{ asset($subMenu->menudtl_link) }}"
                                    ...
                                    <div data-i18n="Cards">{{ $subMenu->menudtl_title }}</div>
                                    <!-- <div class="badge bg-label-primary rounded-pill ms-auto">6</div> -->
                                </a>
                                <ul class="menu-sub">
                                    @foreach ($subMenu->subMenuDetails as $key => $detail)
                                        <li class="menu-item">
                                            <a href="{{ asset($detail->menudtlsub_link) }}" class="menu-link">
                                                <div data-i18n="Basic">{{ $detail->menudtlsub_title }}</div>
                                            </a>
                                        </li>
                                    @endforeach
                ...
                <nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            {{-- Sign Out --}}
                            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                                <a class="nav-link dropdown-toggle hide-arrow" href="{{ route('logout') }}"><i
                                        class="ti ti-logout ti-md"></i>
                                </a>
                            </li>
